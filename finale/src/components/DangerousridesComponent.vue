<template>
  <div class="dangerous-rides">
    <nav>
      <ul>
        ...
        <li><a href="#Formula-Rossa">Formula Rossa</a></li>
        <li><a href="#Kingda-ka">Kingda-ka</a></li>
        <li><a href="#Eejanaika">Eejanaika</a></li>
        <li><a href="#Expoland">Expoland</a></li>
        <li><a href="#Smiller">Smiller</a></li>
        <li><a href="#Veruct">Veruckt</a></li>
        <li><a href="#Tower-of-Terror">Tower of Terror</a></li>
      </ul>
    </nav>
 ...
 <h2 id="Tower-of-Terror">Tower of Terror II</h2>
